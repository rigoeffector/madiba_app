...
class AudioBookDetailPlay extends StatefulWidget {
  @override
  _AudioBookDetailPlayState createState() => _AudioBookDetailPlayState();
}

class _AudioBookDetailPlayState extends State<AudioBookDetailPlay> {
  Duration duration;
  Duration position;
        ...
        child: Center(
          child: Center(
            child: Column(
              ...
              children: [
                Text(
                  'The Angry birds Audio Book reading',
